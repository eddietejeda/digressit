...
?>
<link rel="stylesheet" href="<?php echo get_digressit_media_uri(); ?>/lightboxes.css" type="text/css" media="screen" />
<?php
}

function lightboxes_wp_print_scripts(){	
	wp_enqueue_script('digressit.lightboxes', get_digressit_media_uri().'/lightboxes.js', 'jquery', false, true );
}
