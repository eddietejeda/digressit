...
preg_match('#paragraphcomments/(.+)#', $_SERVER['REQUEST_URI'], $gets);

$get = $gets[1];
list($post_identifier, $paragraph_number) = explode(',', $get);
...
//var_dump($paragraph_number);
$approved_comments = $digressit_commentbrowser->get_approved_comments_for_paragraph($post->ID, (int)$paragraph_number);
