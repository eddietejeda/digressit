...
//		}
	...
	{
		global $wpdb;
		$sql = "SELECT *, COUNT(*) as user_comment_count FROM $wpdb->comments c WHERE c.comment_approved = 1 AND c.comment_text_signature = 0 OR c.comment_text_signature = NULL GROUP BY comment_author";
